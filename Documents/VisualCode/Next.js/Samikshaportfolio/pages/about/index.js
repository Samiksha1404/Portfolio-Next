...
//               return (
//                 <div 
//                 key={itemIndex} className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <motion.p
            ...
            className="max-w-[500px] text-sm mx-auto xl:mx-0 xl:mb-4 px-2 xl:px-0"
          >
            Hello! I&apos;m Samiksha Gupta, a final-year student and enthusiastic web developer, designer, and coder. Specializing in frontend development, I have a keen eye for design and a passion for creating seamless, interactive user experiences. My journey began with a fascination for how technology transforms ideas into reality.
          </motion.p>
          <motion.p
            variants={fadeIn('right', 0.6)}
            initial="hidden"
            ...
            className="max-w-[500px] text-sm mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0"
          >
            Skilled in coding and problem-solving, I turn ideas into user-friendly solutions. With a focus on clean, adaptable code, every project I tackle is robust and developer-friendly.
          </motion.p>
          {/* counter */}
          <motion.div
            variants={fadeIn('right', 0.6)}
